...
class MultiClassDataLoader(object):
    ...
    def define_flags(self):
        self.__flags.DEFINE_string("train_data_file", "./data/rt-polaritydata/rt-polarity.train", "Data source for the training data.")
        self.__flags.DEFINE_string("dev_data_file", "./data/rt-polaritydata/rt-polarity.dev", "Data source for the cross validation data.")
        self.__flags.DEFINE_string("class_data_file", "./data/rt-polaritydata/rt-polarity.cls", "Data source for the class list.")

    def prepare_data(self):
        self.__resolve_params()
        x_train, y_train = self.__load_data_and_labels(self.__train_data_file, self.__class_data_file)
        x_dev, y_dev = self.__load_data_and_labels(self.__dev_data_file, self.__class_data_file)
